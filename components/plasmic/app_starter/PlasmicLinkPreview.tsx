...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: -zrFUqPL7HC2/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__w0Iy)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__qYnoU)}>
              <div className={classNames(projectcss.all, sty.freeBox__sFApm)}>
                <h5
